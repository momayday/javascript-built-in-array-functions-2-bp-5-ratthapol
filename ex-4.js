...
const billsMembers = bills.filter(bill => bill.member !== null);
const memberNames = billsMembers.map(bill => bill.member.name);
const uniqueMemberNames = new Set(memberNames);
const totalMembers = uniqueMemberNames.size;
